...
public class GetInput {
  ...
  public int getBestOutOf() {
    ...
    do {
      if ((sc.hasNextInt()) && (bestOf = sc.nextInt()) >= 2 || ((bestOf % 2 == 0) || (bestOf < 1))) {
  ...
  public int userThrow() {
    ...
    do {
      if ((sc.hasNextInt()) && (playerThrow = sc.nextInt()) >= 2 || (playerThrow > 5 || playerThrow < 1)) {
        if (playerThrow < 6 && playerThrow > 0) { }
        else {
    ...
    } while (playerThrow > 5 || playerThrow < 1);
  ...
  public int GetGuessNumber(){
      ...
      if ((GuessNumber.hasNextInt()) && ((totalGuesses = GuessNumber.nextInt()) >= 1) && (totalGuesses < range_num)){
          ...
          System.out.println("Error: Please enter valid number of guesses");
          GetGuessNumber();
      }
      else {
          System.out.println("Error: Please enter valid number of guesses");
